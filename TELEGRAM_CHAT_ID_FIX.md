...
3. 브라우저에서 접속 (YOUR_BOT_TOKEN을 실제 토큰으로 교체):
   ...
   ```
4. JSON 응답에서 `"chat":{"id":123456789}` 값 확인
...
4. **음수**인지 확인 (그룹 채팅은 음수, 예: `-1003234073437`)
...
- **그룹 채팅 ID는 음수**입니다 (예: `-1003234073437`)
- **개인 채팅 ID는 양수**입니다 (예: `123456789`)
